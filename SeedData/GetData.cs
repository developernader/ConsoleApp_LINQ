...
public static class GetData
{
    ...
    public static List<Customer> GetCustomers()
    {
        ...
        customers.Add(new Customer() { Id = 104, Name = "Said Naser", Age = 62, IsActive = false, JoinDate = new DateTime(2022, 03, 17), SpendAverage = 4503.3m, Telephone = 01074848480 });
        ...
        customers.Add(new Customer() { Id = 106, Name = "Tarq mohamed", Age = 25, IsActive = true, JoinDate = new DateTime(2022, 07, 15), SpendAverage = 6425.1m, Telephone = 01287236012 });
        return customers;
    }
